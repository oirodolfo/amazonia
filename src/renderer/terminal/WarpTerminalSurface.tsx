 ...
 */
export function WarpTerminalSurface(props: WarpTerminalSurfaceProps): React.ReactElement {
    ...
    return (
        <div
            className="grid h-full grid-cols-[1fr_420px] overflow-hidden rounded-[28px] border border-white/10 bg-[#111111] shadow-[0_0_120px_rgba(16,185,129,0.18)]">
            <section className="flex min-h-0 flex-col overflow-hidden border-r border-white/5">
                <header className="flex items-center justify-between border-b border-white/5 bg-[#18181b] px-5 py-3">
                    ...
                    <div
                        className="rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-[11px] font-semibold text-emerald-300">
                        PTY LIVE
                    </div>
                </header>
                ...
                <div className="flex-1 overflow-auto p-4">
                    <div className="space-y-4">
                      ...
                      {block.status}
                                ...
                                <pre
                                    className="max-h-80 overflow-auto whitespace-pre-wrap p-4 font-mono text-[12px] leading-6 text-zinc-300">
                  {block.output}
                </pre>
                            </article>
                        ))}
