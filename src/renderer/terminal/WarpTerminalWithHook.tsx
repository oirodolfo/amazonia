 ...
 * ```
 */
export function WarpTerminalWithHook(props: WarpTerminalWithHookProps): JSX.Element {
  ...
  return (
    <div className="grid h-full grid-cols-[1fr_20rem] gap-3">
      <section className="flex min-h-0 flex-col overflow-hidden rounded-[1.75rem] border border-emerald-400/15 bg-[#111111]">
