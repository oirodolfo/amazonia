 ...
 * ```
 */
export function TerminalProblemsPanel(props: TerminalProblemsPanelProps): React.ReactElement {
    return (
        <section className="rounded-[1.5rem] border border-red-400/10 bg-black/30">
            ...
            <div className="max-h-96 overflow-auto p-3">
                ...
                <span
                    className={problem.severity === 'error' ? 'text-xs font-semibold text-red-300' : 'text-xs font-semibold text-amber-300'}>
                  {problem.title}
                </span>
