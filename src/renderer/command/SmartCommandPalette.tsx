...
export function SmartCommandPalette(props: SmartCommandPaletteProps): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 p-[8vh] backdrop-blur-xl" onClick={() => props.onOpenChange(false)}>
      <Command
            ...
            <Command.Group heading={props.t('command.suggested')}>
              {props.suggestions.map((suggestion) => (
                ...
                >
                  ...
                  <span className="rounded-xl border border-emerald-400/20 bg-emerald-400/5 px-2 py-1 text-xs text-emerald-300">
