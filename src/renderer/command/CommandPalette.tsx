...
export function CommandPalette(props: CommandPaletteProps): React.ReactElement | null {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 p-[10vh] backdrop-blur-md"
            ...
            <Command
                ...
                <Command.List className="max-h-[55vh] overflow-auto p-2">
                    <Command.Empty
                        className="p-6 text-center text-sm text-zinc-500">{props.t('command.empty')}</Command.Empty>
