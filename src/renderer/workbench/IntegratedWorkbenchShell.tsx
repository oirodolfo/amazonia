...
export function IntegratedWorkbenchShell(props: IntegratedWorkbenchShellProps): React.Element {
    ...
    return (
        <div className="h-screen w-screen overflow-hidden bg-[#020605] text-zinc-100">
            <div
                className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.16),transparent_30%),radial-gradient(circle_at_85%_20%,rgba(56,189,248,0.11),transparent_25%),radial-gradient(circle_at_50%_90%,rgba(167,139,250,0.10),transparent_32%)]"/>
            ...
            <div className="relative h-full">
                <Group direction="horizontal">
                    ...
                    <Panel minSize={38} defaultSize={52}>
                        <main className="h-full p-3">
                            {activeSessionId ? (
                                ...
                                <div
                                    className="flex h-full items-center justify-center rounded-[2rem] border border-dashed border-emerald-400/20 bg-zinc-950/70 text-sm text-zinc-500">
                    ...
                    <Panel minSize={24} defaultSize={26}>
                        <aside
                            className="flex h-full flex-col gap-3 overflow-auto border-l border-emerald-400/10 bg-zinc-950/70 p-3 backdrop-blur-xl">
